        ...
        <div className='mb-10'>
            ...
            <div className='flex justify-between items-center px-2'>
                <div className='flex gap-4 '>
                    <img className='w-11 rounded-3xl shadow-xl' src={author_image} alt="" />
                    <div>
                ...
                <div className='flex gap-3'>
                    ...
                    <p className='text-primary' onClick={()=>handleBookmark(blog_title, id)} href=""><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <button style={{display:'inline-block'}} onClick={()=>handleWatchTime(read_time)} className='cursor-pointer text-primary underline' href="">Mark as read</button>
